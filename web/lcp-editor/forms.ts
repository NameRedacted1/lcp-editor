...
const CATEGORY_LAYOUTS = (): Record<string, LayoutSpec> => {
  ...
  'npc_features.json': lay('npcf', [
    ...
    ['Combat', [txt('weapon_type', { optional: true }), sel('activation', 'activations', { optional: true }), f('damage', 'damage', { optional: true, tiered: true }), f('range', 'range', { optional: true }), f('tierscalar', 'attack_bonus', { optional: true }), f('tierscalar', 'accuracy', { optional: true }), txt('mod', { optional: true })]],
...
const V2_CATEGORY_LAYOUTS = (): Record<string, LayoutSpec> => {
  ...
  'npc_features.json': lay('npcf', [
    ...
    ['Combat', [txt('weapon_type', { optional: true }), txt('tech_type', { optional: true }), f('damage', 'damage', { optional: true, tiered: true, rowKey: 'damage' }), f('range', 'range', { optional: true }), f('tierscalar', 'attack_bonus', { optional: true }), f('tierscalar', 'accuracy', { optional: true }), num('attacks', 1, 9, { optional: true }), txt('mod', { optional: true })]],
    ['Effect', [area('effect'), area('trigger'), area('on_hit', { optional: true }), area('description', { optional: true })]],
    ['Tags', [f('tags')]],
    ['Counters', [rows('counters', COUNTER_COLUMNS, { optional: true })]],
    ['Actions', [rows('actions', ACTION_COLUMNS, { optional: true })]],
    ['Active Effects', [rows('active_effects', ACTIVE_EFFECT_COLUMNS, { optional: true })]],
